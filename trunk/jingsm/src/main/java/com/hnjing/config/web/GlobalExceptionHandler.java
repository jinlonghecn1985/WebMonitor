...
import com.hnjing.config.web.exception.SecurityHeaderException;
import com.hnjing.config.web.exception.UniqueException;
import com.hnjing.utils.HttpCodeEnum;
...
public class GlobalExceptionHandler {
    ...
    * @author: li chao
	 ...
	 * @return
	 */
	@ExceptionHandler(SecurityHeaderException.class)
	public Map<String, Object> securityHeaderException(SecurityHeaderException e, HttpServletResponse response) {
	    logger.error("无权限", e);
		Map<String, Object> returnMap = Maps.newHashMap();
		response.setStatus(HttpCodeEnum.HTTP_NO_PERMISSION.getCode());
		returnMap.put("code", HttpCodeEnum.HTTP_NO_PERMISSION.getCode());
		returnMap.put("message", "无权限异常");
